      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-7xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">The Shaw Motor Plaza Corp - Updated: April 2026</p>
          </div>
          <Button
            variant="ghost"
            size="icon"
        ...
        <div className="flex items-center justify-between p-6 border-t border-gray-200 bg-gray-50">
          <div className="text-xs text-gray-500">
            ...
            <p><strong>SRP:</strong> Suggested Retail Price | <strong>DNP:</strong> Dealer Net Price | <strong>WS:</strong> Wholesale Subsidy</p>
            <p><strong>DNP LESS WS:</strong> Dealer Net Price Less Wholesale Subsidy | <strong>EWT:</strong> Expanded Withholding Tax</p>
          </div>
