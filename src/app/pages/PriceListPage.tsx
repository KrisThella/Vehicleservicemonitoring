...
const initialPrices: PriceItem[] = [
  ...
  {
    model: "XL7 1.5 GLX AT - HYBRID (TWO-TONE) BLACK EDITION",
    srp: "1,269,000.00",
    dnp: "",
    wsSubsidy: "",
    dnpLessWsSubsidy: "",
...
export function PriceListPage() {
  ...
  const [newItem, setNewItem] = useState<PriceItem>({
    model: "",
    ...emptyNewItem(),
  });
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Manage vehicle pricing information
              </p>
            </div>
          </div>
          <Button
